        ...
        {appState !== 'loading' && (
            <header className="flex items-center justify-between p-3 sm:p-5 sticky top-0 z-50 bg-white border-b">
                ...
                <div className="flex items-center space-x-2">
                    <div className="bg-indigo-600 p-1.5 sm:p-2 rounded-xl sm:rounded-m">
                        <FileText className="text-white h-4 w-4 sm:h-5 sm:w-5" />
                    </div>
                    <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2">
                        <h1 className="text-base sm:text-xl lg:text-2xl font-bold text-indigo-600">
                            Dental Chart Digitizer
                        </h1>
                        <span className="text-xs font-bold sm:text-sm bg-indigo-100 text-indigo-700 px-2 py-0.5 sm:py-1 rounded-full inline-block w-fit flex-shrink-0">
                            AI Powered
                        </span>
                    </div>
                </div>
